    ...
    for city_idx = 1:length(city_sizes)
        ...
        for rho_idx = 1:length(rhosizes)
            ...
            % Generate error terms for two city sizes
                ...
                %[hateta3_wq_J,var_wq_J]=incomplete_Us_NO_debias_standz(city_size,Jn,e_ij,3);
                bound_1 = sqrt(log(city_size)/city_size);
                bound_2 = (log(city_size)/city_size);
                
                results(i, :) = [hatrho_J,hateta3_J,hateta3_full,var_source_Gamma1,var_source_Gamma2,var_source_Gamma3,jn,var_source_Gamma1_2,var_source_Gamma1_full,hatrho_J2,hateta3_J2,hateta3_full2,var2_source_Gamma1,var2_source_Gamma2,var2_source_Gamma3,jn2,var2_source_Gamma1_2,var2_source_Gamma1_full,city_size,city_size+50,rhosize,rhosize+0.1,alpha,r];
...
writetable(T, "eta3_param_r3_normal_nondegen_0.04_sparse_two.csv", 'Delimiter', ';','WriteVariableNames', true);
