    ...
    for city_idx = 1:length(city_sizes)
        ...
        for rho_idx = 1:length(rhosizes)
            ...
            % Generate error terms for two city sizes
                ...
                [e_ij2,omega_ij2] = WE_alter(city_size+100, rhosize+0.1,"normal",5,0);
            %E2 = WE_null(city_size + 100, rhosize + 0.1);
                ...
                Jn2=getsubset(city_size+100,alpha,r);
                ...
                results(i, :) = [hatrho_J,hateta3_J,hateta3_full,var_source_Gamma1,var_source_Gamma2,var_source_Gamma3,jn,var_source_Gamma1_2,var_source_Gamma1_full,hatrho_J2,hateta3_J2,hateta3_full2,var2_source_Gamma1,var2_source_Gamma2,var2_source_Gamma3,jn2,var2_source_Gamma1_2,var2_source_Gamma1_full,city_size,city_size+100,rhosize,rhosize+0.1,alpha,r];
...
T = array2table(test_stat_1, 'VariableNames', {'hatrho_J','hateta3_J','hateta3_full','var_source_Gamma1','var_source_Gamma2','var_source_Gamma3','jn','var_source_Gamma1_2','var_source_Gamma1_full','hatrho_J2','hateta3_J2','hateta3_full2','var2_source_Gamma1','var2_source_Gamma2','var2_source_Gamma3','jn2','var2_source_Gamma1_2','var2_source_Gamma1_full','n1','n2','rho1','rho2','alpha','r'});
...
writetable(T, "eta5_param_r3_normal_deg_null_sparsity_twosample.csv", 'Delimiter', ';','WriteVariableNames', true);
